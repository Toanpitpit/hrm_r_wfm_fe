...
### Thông tin component:
- **Tên component**: [TÊN_COMPONENT] (VD: UserCard, ProductList)
- **Mô tả chức năng**: [MÔ_TẢ] (VD: Hiển thị thông tin người dùng dạng card)
- **Props nhận vào**: [DANH_SÁCH_PROPS] (VD: user: { name, email, avatar }, onClick)
- **Có state riêng không?**: [CÓ/KHÔNG] (nếu có, liệt kê state)

### Quy tắc bắt buộc:
1. Đặt file tại: `src/components/[TÊN_COMPONENT]/index.jsx`
2. CSS dùng CSS Modules: `src/components/[TÊN_COMPONENT]/[TÊN_COMPONENT].module.css`
