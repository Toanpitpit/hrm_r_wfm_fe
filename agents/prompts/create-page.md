...
### Thông tin page:
- **Tên page**: [TÊN_PAGE] (VD: LoginPage, DashboardPage, UserListPage)
...
### Quy tắc bắt buộc:
1. Đặt file tại: `src/pages/[TênPage]/index.jsx`
2. CSS dùng CSS Modules: `src/pages/[TênPage]/[TênPage].module.css`
